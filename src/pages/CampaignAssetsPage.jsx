...
const CampaignAssetsPage = () => {
  ...
  const generateAssets = async () => {
    setLoading(true);
    try {
      // Simulate API call to generate assets
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-green-50">
        ...
        <div className="flex items-center justify-center min-h-[80vh]">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Generating Your Campaign Assets</h2>
            <p className="text-gray-600 mb-8">Our AI is creating QR codes, social media posts, and pamphlets...</p>
        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className={`mb-8 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-sm font-medium text-green-600">Suggestions</span>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-sm font-medium text-purple-600">Assets</span>
                </div>
              </div>
            </div>
            ...
            <p className="text-xl text-gray-600">
              Your QR codes, social media posts, and pamphlets are ready to download and share
            </p>
          </div>
              ...
              <div className="p-8">
                <div className="grid md:grid-cols-2 gap-6">
                  {assets.qrCodes.map((qr) => (
                    <div key={qr.id} className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-200">
                      <div className="text-center mb-4">
                        <img src={qr.url} alt={qr.name} className="w-48 h-48 mx-auto rounded-2xl shadow-lg" />
                      </div>
                      <h3 className="font-bold text-gray-900 mb-2">{qr.name}</h3>
                      <p className="text-sm text-gray-600 mb-4">Scans: {qr.scans}</p>
              ...
              <div className="p-8">
                <div className="grid lg:grid-cols-3 gap-6">
                  {assets.socialMediaPosts.map((post) => (
                    <div key={post.id} className="bg-gradient-to-br from-pink-50 to-orange-50 rounded-2xl p-6 border border-pink-200">
                      <div className="mb-4">
                        <img src={post.imageUrl} alt={`${post.platform} post`} className="w-full h-40 object-cover rounded-xl" />
                      </div>
                      <h3 className="font-bold text-gray-900 mb-2">{post.platform} Post</h3>
                      <div className="bg-white rounded-xl p-4 mb-4 text-sm">
                        <p className="text-gray-700 whitespace-pre-line">{post.content}</p>
                      </div>
                      <div className="space-y-2">
                        <button
                          onClick={() => handleDownload(post, 'Social Media Post')}
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-lg border border-white/20">
              <div className="px-8 py-6 border-b border-gray-100">
                <div className="flex items-center">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900">Print Materials</h2>
                </div>
              </div>
              <div className="p-8">
                <div className="grid md:grid-cols-2 gap-6">
                  {assets.pamphlets.map((pamphlet) => (
                    <div key={pamphlet.id} className="bg-gradient-to-br from-green-50 to-teal-50 rounded-2xl p-6 border border-green-200">
                      <div className="mb-4">
                        <img src={pamphlet.previewUrl} alt={pamphlet.name} className="w-full h-48 object-cover rounded-xl" />
                      </div>
                      <h3 className="font-bold text-gray-900 mb-2">{pamphlet.name}</h3>
                      <p className="text-sm text-gray-600 mb-4">{pamphlet.description}</p>
                      <button
